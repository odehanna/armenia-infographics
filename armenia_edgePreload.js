...
var plSTF="width",ctrPlS="horizontal",minPlW="240px",maxPlW="750px",plWidth="750px",plHeight="1060px";
...
dlContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['0px', '0px','749px','1059px','auto', 'auto'],
        fill: ["rgba(0,0,0,0)",'images/Armenia_opt4.jpg','0px','0px']
    }]};//simpleContent
